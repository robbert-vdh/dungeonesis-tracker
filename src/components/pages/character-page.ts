...
// TODO: Add buying inspiration somewhere, perhaps add the bottom of the 'Add
//       stars' dropdown? Make sure to make the item red if we go with this.
// TODO: Compensate for having partial banners, since this is not possible in
//       the current system. This is only an issue when calculating quest
//       rewards.
...
interface Reward {
   ...
   */
  reward: (character: utils.CharacterProgression) => number;
}
  ...
  availableRewards: (Reward | "divider")[] = [
    {
      ...
      reward: character => utils.bannerCost(character, 1, true)
    },
    {
      name: "Completed a quest (2 banners)",
      characterBound: false,
      reward: character => utils.bannerCost(character, 2, true)
    },
    {
